      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-5xl mx-auto animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto">
            引领智能机器人技术革命，打造下一代人机协作解决方案
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="group bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow hover:shadow-glow-strong transition-all text-lg px-8 py-6"
            >
              探索产品
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="group border-primary/50 hover:border-primary text-foreground hover:bg-primary/10 text-lg px-8 py-6"
            >
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 max-w-3xl mx-auto">
            {[
              ...
              <div 
                key={index} 
                className="text-center animate-slide-up backdrop-blur-sm bg-card/50 rounded-lg p-6 border border-primary/20"
