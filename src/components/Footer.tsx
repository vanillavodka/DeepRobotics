    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <img src={logo} alt="RoboTech Logo" className="h-8" />
          ...
          {/* Support */}
          <div>
            <h3 className="font-semibold mb-4 text-foreground">服务支持</h3>
            <ul className="space-y-2">
              <li>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-semibold mb-4 text-foreground">联系我们</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-muted-foreground">
                <MapPin className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span className="text-sm">杭州市余杭区文一西路1818号</span>
              </li>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © 2024 云深处科技. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
